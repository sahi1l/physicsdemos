...
function Ang(x,y){
    ...
    return Math.atan2(y-paper.canvas.offsetTop-pivotY,x-paper.canvas.offsetLeft-pivotX)/Math.PI*180;
}
...
function init(){
    ...
    block.attr({fill:"black",stroke:"black",opacity:0.1});
    bblock=paper.rect(pivotX-width,pivotY-height,width,height).attr({fill:"black",stroke:"black"});
    bblock.toBack();
    //Gravity:
