...
class Card {
    ...
    html(){
        ...
        let animatedQ = this.img.endsWith("gif");
        html += `<div class="img"><img class="${animatedQ?"animated":""}" src="lib/main/img/${this.img}">\n`;
        if (animatedQ){
            html += `<img class="staticoverlay" alt=" " src="lib/main/img/${this.img.replace(".gif",".png")}">\n`;
        }
        html += "</div>";
